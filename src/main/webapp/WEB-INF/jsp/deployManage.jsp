			...
			<div class="wrapper">
					...
					<jsp:include page="iniLeftHref.jsp"></jsp:include>
						...
						<nav aria-label="Page navigation" style="position: fixed; right: 15px; bottom: 30px;">
							  <ul class="pagination ">
							    <li>
	                         <a href="${APP_PATH}/admin/deploy/deployPage?pn=1">首页</a>
	                     </li>
	                     <c:if test="${pageInfo.hasPreviousPage}">
	                         <li>
	                             <a href="${APP_PATH}/admin/deploy/deployPage?pn=${pageInfo.pageNum-1}" aria-label="Previous">
	                     ...
	                     <c:forEach items="${pageInfo.navigatepageNums}" var="pageNum">
	                         ...
	                         <c:if test="${pageNum!=pageInfo.pageNum}">
	                             <li>
	                                 <a href="${APP_PATH}/admin/deploy/deployPage?pn=${pageNum}">${pageNum}</a>
	                             </li>
	                         </c:if>
	                     </c:forEach>
	                     ...
	                     <c:if test="${pageInfo.hasNextPage }">
	                         <li>
	                             <a href="${APP_PATH}/admin/deploy/deployPage?pn=${pageInfo.pageNum+1}" aria-label="Next">
	                     ...
	                     <li>
	                         <a href="${APP_PATH}/admin/deploy/deployPage?pn=${pageInfo.pages}" aria-label="Next">
