					...
					<jsp:include page="iniLeftHref.jsp"></jsp:include>
						...
						<nav aria-label="Page navigation" style="position: fixed; right: 15px; bottom: 30px;">
	                     ...
	                     <c:if test="${pageInfo.hasPreviousPage}">
	                         <li>
	                             <a href="${APP_PATH}/admin/user/userPage?pn=${pageInfo.pageNum-1}&name=${name}" aria-label="Previous">
                        ...
                        <li class="active">
	                     ...
	                     <c:if test="${pageInfo.hasNextPage }">
	                         <li>
	                             <a href="${APP_PATH}/admin/user/userPage?pn=${pageInfo.pageNum+1}&name=${name}" aria-label="Next">
	                     ...
	                     <li>
	                         <a href="${APP_PATH}/admin/user/userPage?pn=${pageInfo.navigatepageNums}&name=${name}" aria-label="Next">
